...
I have decided to make an Open Source copy of my project as it is after the first day working on it. I have learned much from being able to look at other people's code and hope others can get started quickly as well.
