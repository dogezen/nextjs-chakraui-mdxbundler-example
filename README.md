...
The app also makes use of [mdx-bundler](https://github.com/kentcdodds/mdx-bundler) to produce a blog from `.mdx` files.

The details of how the app was built are found in this [blog post](https://experientialgrowth.vercel.app/blog/how-i-built-this-blog-website).
